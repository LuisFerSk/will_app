...
class _FormWidgetState extends State<FormWidget> with SignInValidationMixin {
    ...
    return BlocListener<SignInCubit, SignInState>(
      listener: (context, state) {
        ...
        if (state is SignInSuccess) {
          String token = state.singIn.token;

          pop();
          TokenPreferences.setToken(token);
          context.read<VerifyTokenCubit>().getVerifyToken(token.toString());
        }
